    ...
    <div className="section">
      ...
      {logs.length === 0 ? (
        <div className="log-empty">
          ...
          >
            MOZ_LOG="Graphics:5"
            MOZ_LOG_FILE="~/.cache/firefox-hud/mozlog_graphics.txt" firefox
          </code>
        </div>
      ) : (
        <>
          <div className="log-stats">
            ...
            {warnCount > 0 && (
              <span className="log-stat log-stat-warn">
                ⚠ {warnCount} delays
              </span>
            )}
            {errorCount > 0 && (
            ...
            {warnCount === 0 && errorCount === 0 && (
              <span className="log-stat log-stat-ok">✓ No issues</span>
            )}
          </div>
